...
func _init() -> void:
	...
	LimboConsole.register_command(_hud, "hud", "Open a HUD popover by name (gamemenu, unimenu, students, housing, money, reputation, build) or a pane (construction, admissions, academic, dorm, dining); popup shows the latest report; none closes it.")
